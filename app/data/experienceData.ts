  ...
  tr: [
    {
      ...
      company: "Turkcell",
      description: "Turkcell'in dijital dönüşüm projelerinde liderlik rolü üstlenerek, yenilikçi çözümler geliştiriyorum. Ekip yönetimi ve mentorluk yaparak, şirketin teknolojik vizyonuna katkıda bulunuyorum.",
    ...
    },
    {
      ...
      description: "Banka'nın çeşitli dijital ürünlerinin geliştirilmesinde görev aldım. Müşteri deneyimini iyileştiren ve işlem güvenliğini artıran projeler üzerinde çalıştım.",
    ...
    },
    {
      ...
      company: "Trendyol",
      description: "E-ticaret platformunun hem ön yüz hem de arka yüz geliştirmelerinde aktif rol aldım. Performans optimizasyonu ve ölçeklenebilirlik üzerine çalışmalar yaptım.",
    ...
    },
    {
      ...
      company: "Vodafone",
      description: "Telekom sektöründe müşteri hizmetleri ve faturalama sistemleri üzerinde çalıştım. Büyük veri işleme ve analizi konularında deneyim kazandım.",
